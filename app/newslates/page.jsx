...
export default function NewslatesPage() {
  return (
    <main className="max-w-5xl mx-auto py-24 px-6">
      <h1 className="text-4xl font-bold mb-4">GTA Tech.ai Newslates</h1>
      <p className="text-lg text-slate-600 mb-8">Subscribe to get AI, cloud, product engineering, and digital growth updates from GTA Tech.ai.</p>
