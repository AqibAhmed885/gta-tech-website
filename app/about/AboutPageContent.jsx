  ...
  return (
    <div className="w-full bg-transparent overflow-hidden">
      ...
      <HeroSection
        ...
        subtext="GD Marketing is a team of passionate technologists, designers, and
            innovators dedicated to transforming businesses through cutting-edge
            digital marketing and IT solutions. We believe in the power of technology to create
            positive change."
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div
                  className="absolute inset-0 -z-10  pointer-events-none bg-[#4BAB54]"
                  style={{
                ...
                />
                <div className="absolute w-10 h-10 rounded-l-full top-0 md:left-4 left-0 bg-[#4BAB54]" />
               
                {/* <div className="absolute w-10 h-10  bottom-4 right-4 bg-[#4BAB54]" /> */}
                <div className="absolute w-10 h-10 rounded-r-full bottom-0 right-0 md:right-4 bg-[#4BAB54]" />
      ...
      <section className="relative w-full px-4 md:px-20 py-16 md:py-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl uppercase font-semibold text-[#039932] leading-tight mb-6">
              Introduction
            </h2>
            {/* <h3 className="text-3xl md:text-5xl font-semibold text-[#039932] mb-6">
              Profile
            </h3> */}

            <p className="text-xl md:text-xl leading-relaxed mb-4">
              GD is a company that revolves entirely around creativity established in 2011 with a vision to encapsulate various forms of digital mediums as a quality service.
            </p>

            <p className="text-xl md:text-xl leading-relaxed">
              Initially it was a group of creators &amp; digital experts with a common objective to design solutions for any and all applications that required artistic representation but has now grown with the advent of experienced professionals from the service industry and continues to spread its wings in the IT &amp; design market.
            </p>
          </article>
          ...
          <article className="rounded-[56px_180px_56px_56px]  p-8 md:p-12 ">
            ...
            <p className="text-xl  leading-relaxed mb-4">
              GD has worked closely with numerous entrepreneurs and organizations to develop innovative web-based solutions leveraging the latest internet technologies. The rich user experience made possible by latest technologies has made user experience as good as that of desktop applications.
            </p>

            <p className="text-xl  leading-relaxed mb-4">
              The power to connect with external services regardless of their technology platform has resulted in major boost to incremental and disruptive innovations. GD has been successfully engaged in various web based innovative ventures that promise to change the way people use the web.
            </p>

            <p className="text-xl  leading-relaxed">
              Our experience with end-to-end support for web-based technology ventures enables us to provide a reliable value proposition.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="relative w-full px-4 md:px-20 py-16 md:py-24 bg-[#DEDEE0]">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto bg-[#039932] rounded-xl p-8 md:p-10 text-center mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10 md:mb-14 max-w-4xl mx-auto">
            {teamLeadership.map((member) => (
              <div key={member.name} className="text-center ">
                <div className="relative w-32 h-32 md:w-36 md:h-36 border-4 border-[#039932]  rotate-45 rounded-[72px_72px_4px_72px] overflow-hidden bg-[#039932] mx-auto mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8">
            {teamSpecialists.map((member) => (
              <div key={member.name} className="text-center">
                <div className="w-32 h-32 md:w-36 md:h-36 rotate-45 rounded-[72px_72px_4px_72px] bg-[#039932] mx-auto mb-8 flex items-center justify-center ">
